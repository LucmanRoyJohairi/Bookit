    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                <h5 class="card-title pl-5 pr-5 pb-2 pt-3 text-center">User Information</h5>
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-md-4">
                            <div class="mb-5 text-center" >
                                <img src="{{ asset($user->image) }}" class="" height="150" width="150" alt="">
                            </div>
                        </div>
                        <div class="col-md-4"></div>
                        <div class="col-md-6">
                        <form action="{{ route('logout') }}" method="POST">
                            @csrf
                                ...
                                @endif
                                <div class="mt-5">'
                                <a href="{{ route('admin-dashboard') }}" class="btn btn-primary pl-5 pr-5 btn-block" >Close</a>
                                <input type="submit" class="btn btn-danger pl-5 pr-5 btn-block" value="Logout">
                                </div>
